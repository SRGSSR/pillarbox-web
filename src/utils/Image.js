...
class Image {
   ...
   * @property {String|undefined} [image.width=960] is the width of the image, default value 960.
   * @property {String|undefined} [image.format=jpg] is the format of the image, default value jpg.
   ...
   *
   * @returns {String} the image scaling URL.
   */
  static scale(
